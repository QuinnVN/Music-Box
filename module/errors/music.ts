...
export class NotTheRequester extends UserError {
  constructor() {
    super(
      "You're not the person who requested this song so you can't interact with it!",
    );
  }
}
...
export class NoSongInPlaylist extends UserError {
  constructor() {
    super("There're no song in your playlist!");
  }
}
